...
<p align="center">
  <a href="#五分钟启动">快速开始</a> ·
  <a href="docs/zh-CN/getting-started.md">部署教程</a> ·
  <a href="docs/zh-CN/client-integration.md">客户端接入</a> ·
  <a href="docs/zh-CN/api-compatibility.md">API 兼容性</a> ·
...
<p align="center">
  <img src="docs/images/web-inbox.jpg" width="100%" alt="iamllm 真实会话工作台">
</p>
...
完整行为和已知边界见 [API 兼容性](docs/zh-CN/api-compatibility.md)。
...
生产环境请使用 HTTPS。项目提供了可直接修改的 [Caddy 示例](deploy/Caddyfile.example)。更完整的防火墙、反向代理、备份和升级步骤见 [自托管入门](docs/zh-CN/getting-started.md)。
...
<p align="center">
  <img src="docs/images/web-playground.jpg" width="100%" alt="iamllm 真实 Playground">
</p>
...
<p align="center">
  <img src="docs/images/web-connect.jpg" width="100%" alt="iamllm 真实网页接入指南">
</p>
...
OpenCode、OpenAI Python/JavaScript SDK、Responses API、Gemini、图片和工具调用的完整配置见 [客户端接入教程](docs/zh-CN/client-integration.md)。
...
移动端可处理队列、人工流式回答、工具调用、图片/文件、自动回复、API 密钥申请和设备管理。凭据保存在 iOS Keychain 或 Android Keystore，不保存环境总钥匙。详见 [Flutter 手机端](docs/zh-CN/flutter-mobile.md)。

<p align="center">
  <img src="docs/images/mobile-inbox.png" width="23%" alt="Flutter 会话列表">
  <img src="docs/images/mobile-conversation.png" width="23%" alt="Flutter 回答页面">
  <img src="docs/images/mobile-automation.png" width="23%" alt="Flutter 自动回复">
  <img src="docs/images/mobile-keys.png" width="23%" alt="Flutter API 密钥">
</p>

<p align="center"><sub>以上画面由仓库中的 Flutter App 连接隔离演示实例后，在 iPhone 15 Pro 模拟器中真实渲染。</sub></p>
...
备份、恢复、升级、SSE 反代和密钥轮换见 [运维手册](docs/zh-CN/operations.md)。
...
设计原则和状态模型见 [架构说明](docs/zh-CN/architecture.md)，尚未完成的方向见 [Roadmap](docs/zh-CN/roadmap.md)。

## 文档

| 文档 | 适合谁 |
| --- | --- |
| [自托管入门](docs/zh-CN/getting-started.md) | 第一次把 iamllm 部署到服务器的人 |
| [客户端接入教程](docs/zh-CN/client-integration.md) | 配置 OpenAI、Claude Code、OpenCode、Gemini 的使用者 |
| [API 兼容性](docs/zh-CN/api-compatibility.md) | 正在开发 SDK 或排查协议行为的人 |
| [运维手册](docs/zh-CN/operations.md) | 负责 HTTPS、备份、升级和故障处理的人 |
| [架构说明](docs/zh-CN/architecture.md) | 准备阅读代码或贡献后端的人 |
| [Flutter 手机端](docs/zh-CN/flutter-mobile.md) | 准备调试或发布移动端的人 |
| [Roadmap](docs/zh-CN/roadmap.md) | 想了解项目边界和后续方向的人 |
...
发现安全问题时，请不要在公开 Issue 中附带真实 API Key、会话内容或数据库文件；处理建议见 [安全策略](SECURITY.zh-CN.md)。

## 参与项目

Issue 和 Pull Request 都欢迎。提交代码前请先阅读 [贡献指南](CONTRIBUTING.zh-CN.md)，保持协议适配、应用服务和数据仓储之间的边界，并为行为变更补充测试与文档。
